...
describe('[Challenge] Side entrance', function () {
  ...
  it('Exploit', async function () {
    ...
    const RektSideEntranceLenderPool = await ethers.getContractFactory('RektSideEntranceLenderPool', attacker);
    this.rekt = await RektSideEntranceLenderPool.deploy(this.pool.address);
